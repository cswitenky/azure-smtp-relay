...
This is **NOT** intended to be exposed to the public internet. It is intended to be used as a local SMTP relay server.

There is no authentication or authorization implemented in this SMTP relay server. It is intended to be used in a local development environment or in a private network.
